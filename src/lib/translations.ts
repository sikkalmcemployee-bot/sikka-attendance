...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    autoOutThreshold16h: "18h (8h Credit)",
    maxAutoOut8h: "8h (4h Credit)",
    maxAutoOut16h: "18h (8h Credit)",
    activeShiftSince: (session, timeStr) => `ACTIVE SHIFT SINCE ${timeStr}`,
    markOutAvailableAt: (timeStr, autoThreshold) => `Mark OUT will be available on ${timeStr}${autoThreshold ? ` • Auto OUT threshold: ${autoThreshold}` : ''}`,
    restPeriodActive: "Rest Period Active",
    markInAvailableAt: (timeStr) => `Mark IN will be available at ${timeStr}`,
    activeShiftInProgress: (_session) => `Active Shift In Progress`,
    shiftStarted: (dateStr, timeStr, _autoThreshold?) => `ACTIVE SHIFT IN PROGRESS FROM ${dateStr} ${timeStr}`,
    session1Completed: (hoursStr) => `Session Completed (${hoursStr})`,
    eligibleForMarkIn: "Eligible for Mark IN",
  ...
  hi: {
    ...
    autoOutThreshold16h: "18 घंटे (8 घंटे क्रेडिट)",
    maxAutoOut8h: "8 घंटे (4 घंटे क्रेडिट)",
    maxAutoOut16h: "18 घंटे (8 घंटे क्रेडिट)",
    activeShiftSince: (_session, timeStr) => `सक्रिय शिफ्ट शुरू: ${timeStr}`,
    markOutAvailableAt: (timeStr, autoThreshold) => `आउट दर्ज करना ${timeStr} पर उपलब्ध होगा${autoThreshold ? ` • स्वतः आउट: ${autoThreshold}` : ''}`,
    restPeriodActive: "विश्राम अवधि सक्रिय",
    markInAvailableAt: (timeStr) => `इन दर्ज करना ${timeStr} पर उपलब्ध होगा`,
    activeShiftInProgress: (_session) => `सक्रिय शिफ्ट प्रगति पर है`,
    shiftStarted: (dateStr, timeStr, _autoThreshold?) => `सक्रिय शिफ्ट प्रगति पर है: ${dateStr} ${timeStr}`,
    session1Completed: (hoursStr) => `सत्र पूर्ण (${hoursStr})`,
    eligibleForMarkIn: "इन दर्ज करने के लिए पात्र",
